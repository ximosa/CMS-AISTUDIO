...
Para que el blog sea público pero solo tú puedas editarlo, ejecuta esto en el **SQL Editor**:

```sql
-- Activar seguridad
alter table posts enable row level security;

-- Permitir que TODO EL MUNDO lea los artículos
create policy "Public posts are viewable by everyone"
on posts for select
to anon, authenticated
using ( true );

-- Permitir que SOLO EL USUARIO LOGUEADO pueda crear, editar o borrar
