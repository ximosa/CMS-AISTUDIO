    ...
    <div className="bg-slate-50">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="lg:w-2/3">
            <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight mb-6">
              Creamos Experiencias Digitales <span className="text-indigo-400">Inolvidables</span>
            </h1>
            <p className="text-xl text-indigo-100 mb-8 leading-relaxed">
              Somos expertos en desarrollo web moderno. Ayudamos a tu negocio a crecer con soluciones tecnológicas a medida, rápidas y escalables.
            </p>
      ...
      <section className="py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="mt-4 text-lg text-gray-600">Combinamos diseño, tecnología y estrategia.</p>
        </div>
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="text-gray-600">Desarrollamos aplicaciones web complejas y PWAs que funcionan como software nativo.</p>
          </div>
          <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-md transition-shadow">
            <div className="bg-indigo-100 w-12 h-12 rounded-lg flex items-center justify-center mb-6">
      ...
      <section className="bg-gray-900 py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-indigo-200 mb-8 text-lg">Contáctanos hoy mismo para una consulta gratuita y descubre cómo podemos ayudarte.</p>
          <Link
            to="/contacto"
